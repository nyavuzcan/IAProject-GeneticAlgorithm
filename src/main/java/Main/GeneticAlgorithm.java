...
public class GeneticAlgorithm {
  ...
  public static final int NUMB_OF_ELITE_CHOROMOSOMES = 1;
  ...
  private Population crossoverPopulation(Population population){
    ...
    for (int x = 0 ; x< NUMB_OF_ELITE_CHOROMOSOMES; x++){
      crossoverPopulation.getChromosomes()[x] = population.getChromosomes()[x];
    }
    for (int x = NUMB_OF_ELITE_CHOROMOSOMES; x <population.getChromosomes().length; x++){
